...
const faqs = [
  ...
  ["Can a participant register for the same individual or team event again?", "No. A participant cannot register for an event they have already joined, whether it is an individual or team event. After OTP verification, the system identifies previous registrations and only allows the participant to select from the remaining eligible events."],
