    ...
    <main className="min-h-screen w-full overflow-hidden bg-[#f3f7f6] text-[#12342f]">
      ...
      <section className="relative z-10 mx-auto mt-8 max-w-6xl px-4 pb-20 md:mt-10 md:px-8">
        ...
        <div className="my-6 flex flex-col items-center justify-between gap-3 rounded-2xl bg-[#073f37] px-6 py-5 text-white shadow-lg sm:flex-row">
          ...
          <div className="flex items-center gap-3"><CalendarDays className="text-amber-300" size={21} /><p className="text-base font-semibold uppercase tracking-[0.14em]"><span className="text-amber-300">Saturday</span><span className="mx-2 text-white/35">·</span>03 October 2026</p></div>
        </div>
